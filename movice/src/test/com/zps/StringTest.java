...
我是主演---主　　演　杰森·苏戴奇斯 Jason Sudeikis
   ...
   /* 日期2019-12-16 04:33:46
    日期2019-12-16 03:31:40
    日期2019-12-16 03:24:28*/
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
        Date date = sdf.parse("2019-12-19 04:33:46");
        Long oldTime = date.getTime();
        Long nowTime = new Date().getTime() - 86400000;
        System.out.println("电影毫秒值" + oldTime);
        System.out.println("现在毫秒值" + nowTime);
