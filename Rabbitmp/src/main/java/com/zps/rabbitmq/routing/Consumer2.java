...
public class Consumer2 {
    public static void main(String[] args) throws Exception {
         ...
         * 参数5：其它参数
         */
        channel.queueDeclare(Producer.QUEUE_NAME_UPDATE, true, false, false, null);
        //预期接收一条
        channel.basicQos(2);
        //绑定列队
        channel.queueBind(Producer.QUEUE_NAME_UPDATE, Producer.ROUTING, "update");
        //5，创建消费者
         ...
         * 参数3：消费者
         */
        channel.basicConsume(Producer.QUEUE_NAME_UPDATE, true, defaultConsumer);
