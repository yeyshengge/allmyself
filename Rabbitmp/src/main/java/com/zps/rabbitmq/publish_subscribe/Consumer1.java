...
public class Consumer1 {
    public static void main(String[] args) throws Exception {
        ...
        //声明交换机
        channel.exchangeDeclare(Producer.Exchange, BuiltinExchangeType.FANOUT);
        //4. 声明队列；
        /**
         * 参数1：队列名称
        ...
        channel.basicQos(2);
        //绑定列队
        channel.queueBind(Producer.QUEUE_NAME_1, Producer.Exchange, "");
        //5，创建消费者
        DefaultConsumer defaultConsumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                try {
                    ...
                    System.out.println("消费者一接收信息为:" + new String(body, "utf-8"));
                    Thread.sleep(1000);
                    //确定消费，
                    // 参数一：代表消息id
                    //参数二：false代表当前这条被消费
         ...
         * 参数3：消费者
         */
        channel.basicConsume(Producer.QUEUE_NAME_1, true, defaultConsumer);
